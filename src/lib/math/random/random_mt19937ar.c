...
{
    int i, j, k;
    random_mt19937ar_init_genrand(19650218UL);
    i=1; j=0;
...
unsigned long random_mt19937ar_int32(void)
{
    ...
    if (mti >= N) { /* generate N words at one time */
        ...
        if (mti == N+1)   /* if init_genrand() has not been called, */
            random_mt19937ar_init_genrand(5489UL); /* a default initial seed is used */
...
{
    return (long)(random_mt19937ar_int32()>>1);
}

/* generates a random number on [0,1]-real-interval */
double random_mt19937ar_real1(void)
{
    return random_mt19937ar_int32()*(1.0/4294967295.0); 
    /* divided by 2^32-1 */ 
}
...
{
    return random_mt19937ar_int32()*(1.0/4294967296.0); 
    /* divided by 2^32 */
}
...
{
    return (((double)random_mt19937ar_int32()) + 0.5)*(1.0/4294967296.0); 
    /* divided by 2^32 */
}
...
{ 
    unsigned long a=random_mt19937ar_int32()>>5, b=random_mt19937ar_int32()>>6; 
