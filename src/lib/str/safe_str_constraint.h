 ...
 */
static inline void handle_error(char *orig_dest, rsize_t orig_dmax __UNUSED__,
...
static inline void handle_wc_error(wchar_t *orig_dest, rsize_t orig_dmax __UNUSED__,
                                char *err_msg, errno_t err_code)
{
#ifdef SAFECLIB_STR_NULL_SLACK
    /* null string to eliminate partial copy */
