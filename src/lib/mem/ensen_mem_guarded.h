 ...
 * See \ref ensen_mem_guardedalloc.h
 */

#ifndef ENSEN_MEM_GUARDEDALLOC_H
#define ENSEN_MEM_GUARDEDALLOC_H

/* Needed for uintptr_t and attributes */
...
#endif /* ENSEN_MEM_GUARDEDALLOC_H */
